    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Resume</h2>
          <p>
            Seeking an opportunity with an organization where
            I can utilize and enhance my learning skill in the field of work.
          </p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              ...
              <ul>
                ...
                <li>+91 9960776997</li>
                <li>aadeshpatil650@gmail.com</li>
              </ul>
            </div>
            ...
            <div class="resume-item">
              ...
              <li> Use Kotlin to Build Android for Tracking the
                Insurance Case Process.</li>
                <li> Handled full-stack development for client projects</li>
              </ul>
            </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <p><em>Its an Android App which made for Electric Vehicles Owner to easily find out nearest charging station</em></p>
              <p>Technology Used</p>
              <ul>
                <li>Android</li>
                <li>Java</li>
